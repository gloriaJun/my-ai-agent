...
// 평일 07:00 KST 스케줄. 수동 트리거도 남겨 테스트 실행을 막지 않는다.
//
...
const schedule = trigger({
  ...
  version: 1.1,
  config: {"name": "Weekdays 07:00 KST", "parameters": {"rule": {"interval": [{"field": "cronExpression", "expression": "0 7 * * 1-5"}]}}, "position": [0, -160]},
  output: [{}]
});
...
const manualTrigger = trigger({
  ...
  version: 1,
  config: {"name": "When Run Manually", "position": [0, 160], "parameters": {}},
  output: [{}]
});
