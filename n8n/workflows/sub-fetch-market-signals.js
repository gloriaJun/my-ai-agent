...
const fetch0 = node({
  ...
  version: 4.2,
  config: {"name": "Fetch MOFE 일일경제지표", "onError": "continueRegularOutput", "parameters": {"url": "https://mofe.go.kr/com/detailRssTagService.do?bbsId=MOSFBBS_000000000045", "options": {"response": {"response": {"responseFormat": "text"}}, "timeout": 15000}, "sendHeaders": true, "headerParameters": {"parameters": [{"name": "User-Agent", "value": "household-finance-hub/1.0 (+https://github.com/gloriaJun/my-ai-agent)"}]}}, "position": [224, 0]},
...
const fetch1 = node({
  type: "n8n-nodes-base.httpRequest",
  version: 4.2,
  config: {"name": "Fetch BOK 보도자료", "onError": "continueRegularOutput", "parameters": {"url": "https://www.bok.or.kr/portal/bbs/B0000552/news.rss?menuNo=200690", "options": {"response": {"response": {"responseFormat": "text"}}, "timeout": 15000}, "sendHeaders": true, "headerParameters": {"parameters": [{"name": "User-Agent", "value": "household-finance-hub/1.0 (+https://github.com/gloriaJun/my-ai-agent)"}]}}, "position": [224, 200]},
  output: [{ data: '<raw feed text>' }]
});
...
const fetch2 = node({
  type: "n8n-nodes-base.httpRequest",
  version: 4.2,
  config: {"name": "Fetch 연합인포맥스", "onError": "continueRegularOutput", "parameters": {"url": "https://news.einfomax.co.kr/rss/allArticle.xml", "options": {"response": {"response": {"responseFormat": "text"}}, "timeout": 15000}, "sendHeaders": true, "headerParameters": {"parameters": [{"name": "User-Agent", "value": "household-finance-hub/1.0 (+https://github.com/gloriaJun/my-ai-agent)"}]}}, "position": [224, 400]},
  output: [{ data: '<raw feed text>' }]
});
...
const fetch3 = node({
  type: "n8n-nodes-base.httpRequest",
  version: 4.2,
  config: {"name": "Fetch 연합뉴스 market", "onError": "continueRegularOutput", "parameters": {"url": "https://www.yna.co.kr/rss/market.xml", "options": {"response": {"response": {"responseFormat": "text"}}, "timeout": 15000}, "sendHeaders": true, "headerParameters": {"parameters": [{"name": "User-Agent", "value": "household-finance-hub/1.0 (+https://github.com/gloriaJun/my-ai-agent)"}]}}, "position": [224, 600]},
  output: [{ data: '<raw feed text>' }]
});
...
const fetch4 = node({
  type: "n8n-nodes-base.httpRequest",
  version: 4.2,
  config: {"name": "Fetch Bloomberg markets", "onError": "continueRegularOutput", "parameters": {"url": "https://feeds.bloomberg.com/markets/news.rss", "options": {"response": {"response": {"responseFormat": "text"}}, "timeout": 15000}, "sendHeaders": true, "headerParameters": {"parameters": [{"name": "User-Agent", "value": "household-finance-hub/1.0 (+https://github.com/gloriaJun/my-ai-agent)"}]}}, "position": [224, 800]},
  output: [{ data: '<raw feed text>' }]
});
...
export default workflow('Y1E4O6YiZHh5ulUC', 'Sub-Fetch-Market-Signals')
  .add(whenCalled)
